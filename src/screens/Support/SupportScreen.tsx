...
export default function UserProfileScreen({ navigation }: any) {
  ...
  // Controle das janelas (Simulando Modais com View)
  ...
  return (
    <View style={styles.container}>
      ...
      {/* ========================================== */}
      {/* VIEW CONDICIONAL 1: EDITAR PERFIL */}
      {/* ========================================== */}
      {modalAtivo === 'editar' && (
      ...
      {/* ========================================== */}
      {/* VIEW CONDICIONAL 2: PERGUNTAS FREQUENTES (FAQ) */}
      {/* ========================================== */}
      {modalAtivo === 'faq' && (
      ...
      {/* ========================================== */}
      {/* VIEW CONDICIONAL 3: CONTATO / SUPORTE */}
      {/* ========================================== */}
      {modalAtivo === 'contato' && (
        <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={styles.modalOverlay}>
          <View style={styles.modalContent}>
...
const styles = StyleSheet.create({
  ...
  // O truque de mestre: Transformando uma View num Modal perfeito
  modalOverlay: { 
